...
//double sFR = 0.35; // Cs137
//double eFR = 0.55; // Cs137
double sFR = 1.04;  // Co60 
double eFR = 1.3; // Co60 
          ...
          TString sF = "sim.root")
{
  ...
  // *** sim file ***
  // ****************
  //                     /home/7jn/ldropbox/G4Projects/odessa_1/oneInStilResponse/gamma
  //TFile *f1 = new TFile("/home/7jn/ldropbox/G4Projects/odessa_1/oneInStilResponse/gamma/Co60.root"); // 
  TFile *f1 = new TFile("/home/7jn/ldropbox/G4Projects/odessa_1/oneInStilResponse/gamma/_en_1.3325.root"); // 

  TString channel = "events";
  TTree *t;
  ...
  // exp file
  auto f2 = new TFile( "resCalData/_ch2_co60.root", "read" );
  ...
  T->Draw("d.l * 5.84561088111649E-05 >> hExp"); // Ba133
  //T->Draw("d.l *  >> hExp"); // Co60
