...
//________________
void _ProcessWfs(string fPath = "in.root", string ext = "here") //int sF = 0, int eF = 0)
{
  for(int i=0; i<8; i++)
  {
    string fNum = to_string(i);
    string chNum = to_string(i);
    //string fName = fPath + "/DataR_CH" + chNum + "@DT5730_1132_run_" + ext + ".root";
    //string fName = fPath + "/DataR_CH" + chNum + "@DT5730_1132_" + ext + ".root";
    //DT5730S_13949
    string fName = fPath + "/DataR_CH" + chNum + "@DT5730S_13949_" + ext + ".root";

    string oFName = "_ch" + chNum + "_"  + ext + ".root";
