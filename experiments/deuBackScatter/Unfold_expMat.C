...
// **************
void Unfold_expMat(TString iFN, bool unfold = 1)
{ 
  // read in experiment
  Detector d;
  ...
  T->Draw("odessa.ene >> hL(600,0,6)","CUTG && ej301.psd>0.08 && ej301.l>100000");
  ...
  if(unfold)
  {
    ...
    fio->setNeuEnRange(0.05,12);
    fio->setEnergyIncrement(0.05); // in units of MeV
    fio->setResponse("matrix_OU.txt");
